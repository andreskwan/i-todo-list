...
#import "TH-CoreDataStack.h"

//To encapsulate everything that we need to access core data
@implementation TH_CoreDataStack
...
+(instancetype)defaultStack
{
    ...
    static TH_CoreDataStack *defaultStack;
    //
...
{
    NSURL *dbURL = [[[NSFileManager defaultManager] URLsForDirectory:NSDocumentDirectory
                                                   inDomains:NSUserDomainMask]
            lastObject];
    NSLog(@"DB URL:\n %@",dbURL.absoluteString);
    return dbURL;
}
